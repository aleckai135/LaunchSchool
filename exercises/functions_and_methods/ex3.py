# The following function returns a list of the remainders of dividing the numbers in 
# numbers by 3:
...
# at least one number that is not evenly divisible by 3 (that is, the remainder is not 0):
